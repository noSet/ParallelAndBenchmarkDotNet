# ParallelAndBenchmarkDotNet
Parallel类测试及性能框架使用

- [`Parallel`简单的使用](https://docs.microsoft.com/zh-cn/dotnet/standard/parallel-programming/how-to-write-a-parallel-for-loop-with-thread-local-variables)
- [`BenchmarkDotNet`简单的使用](https://github.com/dotnet/BenchmarkDotNet)
